...
if __name__ == "__main__":
    ...
    def autolabel(rects,labels):
        ...
        for rect in rects:
            ...
            if labels[i] == "22.57":
                plt.text(x,height-0.01,"22.57",verticalalignment="top",horizontalalignment="center",fontsize=6)
            elif labels[i] == "-3.15":
                plt.text(x,height-0.01,"-3.15",verticalalignment="top",horizontalalignment="center",fontsize=6)
            else:   
    ...
    plt.savefig("bars_huge2.pdf",transparent=True)
    plt.show()